...
//   const handleSelectBus = (schedule: ScheduleResponse) => {
...
//     // Later you can fetch booked seats from backend and check here
//     return true;
//   };
...
//     // Assuming 4 seats per row (2-2 configuration)
//     const seatsPerRow = 4;
...
//     // duration comes as "06:00:00", convert to "6h 0m"
...
//                             const seatId = generateSeatId(rowIndex, colIndex + 2);
//                             const isSelected = selectedSeats.includes(seatId);
//                             const isAvailable = isSeatAvailable(seatId);
      ...
      <nav className="bg-white border-b border-gray-200 px-4 py-3 sticky top-0 z-10">
        <div className="container mx-auto flex justify-between items-center">
          ...
          <div className="hidden md:flex space-x-6">
            ...
            <a href="/ticket-booking" className="text-primary font-medium transition-colors">
              Book Tickets
            </a>
            <a href="/my-bookings" className="text-gray-600 hover:text-primary transition-colors">
              My Bookings
            </a>
